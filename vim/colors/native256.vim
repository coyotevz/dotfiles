...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " Default Colors
    call <SID>X("Normal", "f2f2f2", "222222", "")
    call <SID>X("NonText", "444444", "111111", "")
    call <SID>X("Cursor", "", "aaaaaa", "")
    call <SID>X("lCursor", "", "aaaaaa", "")

    " Search
    call <SID>X("Search", "cd853f", "f5deb3", "")
    ...
    " Specials
    call <SID>X("Todo", "e50808", "520000", "bold")
    ...
    " Syntax
    call <SID>X("Number", "3677a9", "", "")
    call <SID>X("Statement", "6aa825", "", "bold")
    call <SID>X("Function", "447fcf", "", "")
    call <SID>X("PreProc", "cd2828", "", "bold")
    call <SID>X("Comment", "999999", "", "")
    call <SID>X("Type", "bbbb84", "", "bold")

    " PopUp Menu
    call <SID>X("Pmenu", "607b8b", "e0eee0", "bold")
    call <SID>X("PmenuSel", "006400", "e0eee0", "bold")
    call <SID>X("PmenuSbar", "607b8b", "", "bold")
    call <SID>X("PmenuThumb", "006400", "", "bold")
