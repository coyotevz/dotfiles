...
hi Folded       guifg=#aaaaaa guibg=#555555
...
" PopUp Menu
hi Pmenu        ctermbg=2 guibg=LightSkyBlue4 guifg=honeydew2 gui=bold
hi PmenuSel     ctermbg=7 guibg=DarkGreen guifg=honeydew2 gui=bold
hi PmenuSbar    ctermbg=0 guibg=LightSkyBlue4 gui=bold
hi PmenuThumb   ctermbg=7 guibg=DarkGreen gui=bold

" Tag List
hi MyTagListFileName  ctermbg=2 guibg=DarkGreen guifg=honeydew2 gui=bold
hi MyTagListTagName   ctermbg=2 guibg=LightSkyBlue4 guifg=honeydew2 gui=bold
